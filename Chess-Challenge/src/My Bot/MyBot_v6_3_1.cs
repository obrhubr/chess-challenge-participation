...
public class MyBot_v6_3_1 : IChessBot
{
    ...
    private (Double, Move) Minimax(Timer timer, Board board, int depth, int maxDepth, double alpha, double beta, Move lastBestMove)
    {
