...
namespace ChessChallenge.Application
{
    public static class MenuUI
    {
        public static void DrawButtons(ChallengeController controller)
        {
            ...
            {
                var whiteType = controller.HumanWasWhiteLastGame ? ChallengeController.PlayerType.MyBotLatest : ChallengeController.PlayerType.Human;
                var blackType = !controller.HumanWasWhiteLastGame ? ChallengeController.PlayerType.MyBotLatest : ChallengeController.PlayerType.Human;
                controller.StartNewGame(whiteType, blackType);
            }
            if (NextButtonInRow("MyBot vs MyBot", ref buttonPos, spacing, buttonSize))
            {
                controller.StartNewBotMatch(ChallengeController.PlayerType.MyBotLatest, ChallengeController.PlayerType.MyBotPrevious);
            }
            if (NextButtonInRow("Unlimited", ref buttonPos, spacing, buttonSize))
            {
                controller.StartNewUnlimitedBotMatch(ChallengeController.PlayerType.MyBotLatest, ChallengeController.PlayerType.MyBotPrevious);
            }
            if (NextButtonInRow("MyBot vs EvilBot", ref buttonPos, spacing, buttonSize))
            {
                controller.StartNewBotMatch(ChallengeController.PlayerType.MyBotLatest, ChallengeController.PlayerType.EvilBot);
            }
